...
/**
 * This class is merely a wrapper of {@link Analytics com.hightouch.analytics.kotlin.core.Analytics}
...
class JavaAnalytics(val analytics: Analytics) {
     ...
     *          through {@link ConfigurationBuilder com.hightouch.analytics.kotlin.core.compat.ConfigurationBuilder}
     */
     ...
     *          {@link Builder com.hightouch.analytics.kotlin.core.compat.Builder}
     ...
     *
     * @param name Name of the action
     * @param serializable an object that implements {@link JsonSerializable com.hightouch.analytics.kotlin.core.compat.JsonSerializable}
     * @see <a href="https://segment.com/docs/spec/track/">Track Documentation</a>
     */
