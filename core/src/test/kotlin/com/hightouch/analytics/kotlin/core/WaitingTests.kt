...
import com.hightouch.analytics.kotlin.core.utils.StubDestinationPlugin
...
class WaitingTests {
    ...
    fun `test pause does not dispatch state if already pause`() {
        mockkStatic("com.hightouch.analytics.kotlin.core.WaitingKt")
        try {
            ...
            unmockkStatic("com.hightouch.analytics.kotlin.core.WaitingKt")
        }
    }
