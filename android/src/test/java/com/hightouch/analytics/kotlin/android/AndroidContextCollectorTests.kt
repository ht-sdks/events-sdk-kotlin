...
import com.hightouch.analytics.kotlin.core.*
import com.hightouch.analytics.kotlin.android.plugins.AndroidContextPlugin
import com.hightouch.analytics.kotlin.android.plugins.getUniqueID
import com.hightouch.analytics.kotlin.android.utils.MemorySharedPreferences
import com.hightouch.analytics.kotlin.android.utils.testAnalytics
...
class AndroidContextCollectorTests {
    ...
    fun setUp() {
        ...
        mockkStatic("com.hightouch.analytics.kotlin.android.plugins.AndroidContextPluginKt")
    ...
    fun `context fields applied correctly`()  {
        ...
        with(event.context) {
            ...
            this["app"]?.jsonObject?.let {
                assertEquals("com.hightouch.analytics.test", it["name"].asString())
                assertEquals("undefined", it["version"].asString())
                assertEquals("com.hightouch.analytics.test", it["namespace"].asString())
